...
public class javaHowSumReduceDP {
  
  static private List<List<Integer>> allCombinationReduceDP(int[] candidates, int target, Map<Integer,List<List<Integer>>> memo ){
    ...
    for (int i=0, n=candidates.length; i<n;i++){
      ...
      List<List<Integer>> result = allCombinationReduceDP(candidates, remainder,memo);
      if (result != null){
  ...
  public static void main(String[] args) {
    ...
    System.out.println(allCombinationReduceDP(candidates, target, new HashMap<>()) );
  }
}
